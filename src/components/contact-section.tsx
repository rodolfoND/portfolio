        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`w-12 h-12 bg-muted rounded-full flex items-center justify-center text-muted-foreground transition-all duration-300 ${social.color}`}
                  >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[#1e40af]/10 to-[#3b82f6]/10 p-6 rounded-lg border border-[#1e40af]/20"
            >
              <h4 className="font-bold mb-2 text-[#1e40af]">Disponibilidade</h4>
              <p className="text-muted-foreground">
                Atualmente disponível para projetos freelance e oportunidades de trabalho remoto. 
